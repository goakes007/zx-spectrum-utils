...
obs1        dz pAt,5,6,pIncx,1,pIncy,0,"A",pRepeat,21
obs2        dz pAt,5,18,"A",pRepeat,21
obs3        dz pAt,26,7,pIncx,0,pIncy,1,"A",pRepeat,3
...
stack_top:
        ...
        SAVENEX OPEN "mini1.nex", main, stack_top
